...
We always welcome contributions to help make `mistify-agent` better. Please take a moment to read this document if you would like to contribute.

### Reporting issues ###

We use [Github issues](https://github.com/mistifyio/mistify-agent/issues) to track bug reports, feature requests, and submitting pull requests.
...
[Fork the project](https://help.github.com/articles/fork-a-repo), clone your fork, and add the upstream to your remote:
    ...
    $ git clone git@github.com:<your-username>/mistify-agent.git
    $ cd mistify-agent
    $ git remote add upstream https://github.com/mistifyio/mistify-agent.git
