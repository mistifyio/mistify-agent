...
var (
	...
	ValidActions = map[string]ActionType{
		...
		"listContainerImages":  InfoAction,
		"getContainerImage":    InfoAction,
		"deleteContainerImage": AsyncAction,
		"pullContainerImage":   AsyncAction,
		"listContainers":       InfoAction,
		"getContainer":         InfoAction,
		"createContainer":      AsyncAction,
		"startContainer":       AsyncAction,
		"stopContainer":        AsyncAction,
		"deleteContainer":      AsyncAction,
	}
)
